...
@DomEvent("leaflet-mouseup")
public class MouseUpEvent extends MouseEvent {

  private static final long serialVersionUID = -1206175999522529677L;

  public MouseUpEvent(LeafletMap source, boolean fromClient,
    ...
    super(source, fromClient, layerId, MouseEventType.mouseup, new LatLng(latitude, longitude),
